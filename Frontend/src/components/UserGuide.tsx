            ...
            <section className="space-y-6">
              ...
              <div className="bg-white/5 p-8 border border-white/5">
                <p className="text-gray-300 leading-relaxed text-base">
                  REACH (Real-time Emergency Alert Collection Hub) is an
                  automated system designed to help people in Pakistan stay
                  informed about critical hazards. It gathers emergency
                  bulletins from various official sources and organizes them
                  into a single, interactive map and dashboard. By using AI to
                  process complex reports, REACH provides clear, actionable
                ...
                <div className="p-6 bg-white/5 border border-white/5">
                  ...
                  <ul className="space-y-4 text-base text-gray-300">
                    <li className="flex gap-3">
                      ...
                      <span>
                        <strong>Centralized Tracking</strong>: We frequently
                        monitor official government bulletins so you don’t have
                        to check multiple websites.
                      </span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-green-500 font-bold">•</span>
                      <span>
                        <strong>Processing</strong>: AI extracts key details
                        such as the severity, type of hazard, affected locations
                        automatically.
                      </span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-green-500 font-bold">•</span>
                      <span>
                        <strong>Mapping</strong>: We turn text-based location
                        data into visual boundaries on a map to show you exactly
                ...
                <div className="p-6 bg-white/5 border border-white/5">
                  ...
                  <ul className="space-y-4 text-base text-gray-300">
                    <li className="flex gap-3">
                      ...
                      <span>
                        <strong>Data Accuracy</strong>: AI-generated mapping and
                        summaries should be cross-referenced with official
                        sources.
                      </span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-red-500 font-bold">•</span>
                      <span>
                        <strong>Duplicates</strong>: You may see multiple
                        entries for the same event if different agencies report
                        on it at different times.
                      </span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-red-500 font-bold">•</span>
                      <span>
                        <strong>Performance</strong>: For the best experience, a
                        stable internet connection and a desktop device are
                        recommended.
                      </span>
                    </li>
                  </ul>
            ...
            <section className="space-y-12">
              ...
              <div className="bg-white/5 p-8 border border-white/5">
                ...
                <p className="text-gray-300 text-base mb-8">
                  The map allows you to see the geographic reach of current
                  hazards at a glance.
                </p>
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="p-4 bg-rich-black/40 border border-white/5">
                      ...
                      <span className="text-gray-300 text-base">
                        Each pin represents the geographical center of an
                        alert's affected area (though not meant to highlight any
                        particular region). The color of the pin indicates the
                        severity level.
                      </span>
                    </div>
                    <div className="p-4 bg-rich-black/40 border border-white/5">
                      ...
                      <span className="text-gray-300 text-base">
                        Click any pin to highlight the affected region and open
                        the <strong>Details Card</strong>.
                      </span>
                    </div>
                  </div>
              ...
              <div className="bg-white/5 p-8 border border-white/5">
                ...
                <p className="text-gray-300 text-base mb-6">
                  Use the Filter Panel to find specific information within a
                  large number of alerts. Click the <strong>"Filters"</strong>{" "}
                  button at the top to show or hide these tools.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 bg-rich-black/40 border border-white/5">
                    ...
                    <span className="text-gray-300 text-base">
                      Search for specific keywords, locations, or types of
                      emergencies. It is designed to handle small typos.
                    </span>
                  </div>
                  <div className="p-4 bg-rich-black/40 border border-white/5">
                    <span className="text-bangladesh-green font-bold block mb-1 uppercase text-sm tracking-wider">
                    ...
                    <span className="text-gray-300 text-base">
                      Filter alerts by active status, all, or specific date
                      ranges.
                    </span>
                  </div>
                  <div className="p-4 bg-rich-black/40 border border-white/5">
                    ...
                    <span className="text-gray-300 text-base">
                      Narrow your view to specific types of hazards (like
                      weather) or threat levels.
                    </span>
                  </div>
                  <div className="p-4 bg-rich-black/40 border border-white/5">
                    <span className="text-bangladesh-green font-bold block mb-1 uppercase text-sm tracking-wider">
                    ...
                    <span className="text-gray-300 text-base">
                      Switch between "Nationwide" to see everything, or "Local"
                      to see alerts near your current GPS location.
                    </span>
                  </div>
                </div>
              </div>
            ...
            <section className="space-y-6">
              <div className="flex items-center justify-center gap-2 mb-4">
                <span className="text-base text-gray-300 font-medium tracking-wider">
                  This guide is available anytime in the{" "}
